...
<div id="create-queenInstallation" class="content scaffold-create" role="main">
    <g:form url="[resource: 'beehive/queenInstallation', action: 'save', beehiveId: params.beehiveId]">
