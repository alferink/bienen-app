...
<div id="edit-varroaCheck" class="content" role="main">
    <g:form url="[resource: 'beehive/varroaCheck', action: 'update', beehiveId: params.beehiveId, id: varroaCheck.id]"
            method="PUT">
        ...
        <b:panel label="${varroaCheck.type.label}" footer="${g.render(template: '/templates/saveAndCancelButtons')}">
